...
const GiftCouponCard = () => {
	...
	const { addToCart, removeFromCart, getCartItems } = useCartStore();
	...
	const handleApplyCoupon = () => {
		// Apply coupon logic (if needed in the future)
		if (!userInputCode) return;
		// Your logic for coupon applying will go here
		// This can be replaced with new discount logic if required
	};
